...
Basically, VoidIsLava is the same as SkyChunks but with lava instead of void. Also, at y below than 2 it wont generate obsidian nor cobblestone, the water also wont flow (spread).
